...
public class SignUpFragmentViewModel extends ViewModel {
    ...
    public LiveData<Boolean> signUpUserLiveData() {
        return isValid;
    }
    ...
    public void signUpUser(SignUp signUp) {
        repository.signUpUser(signUp).subscribeOn(Schedulers.newThread())
                ...
                .subscribe(new SingleObserver<Tokens>() {
                    ...
                    public void onSuccess(@NonNull Tokens tokens) {
                        ...
                        //Using set value because we don't want a delay here.
